...
describe('List Blog test', () => {
  ...
  const user = {
    token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Im1oYW1rMSIsImlkIjoiNjNhOWZhNWI2ZDUwMGM1MjUxMWJlOGU0IiwiaWF0IjoxNjcyMTAwMzc4LCJleHAiOjE2NzIxMDM5Nzh9.Z1L35FjIt6x515bXGTuasHf5s0zkZ4zF_nSciZwBtZE',
    username: 'mhamk1',
    name: 'Mahdi Haydari',
  }
  const blog = {
  ...
  test('5.13: step1 (Blog title and author)', () => {
